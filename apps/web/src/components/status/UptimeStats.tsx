  ...
  return (
    <div className="grid grid-cols-4 gap-4 text-center">
      <div>
        ...
        <div className="text-sm theme-muted">24 hours</div>
      </div>
      <div>
        <div className="text-2xl font-bold">{uptime.week.toFixed(2)}%</div>
        <div className="text-sm theme-muted">7 days</div>
      </div>
      <div>
        <div className="text-2xl font-bold">{uptime.month.toFixed(2)}%</div>
        <div className="text-sm theme-muted">30 days</div>
      </div>
      <div>
        <div className="text-2xl font-bold">{uptime.quarter.toFixed(2)}%</div>
        <div className="text-sm theme-muted">90 days</div>
      </div>
    </div>
  );
}
